...
import type { Cita } from '../../administrador/pages/Cita';
...
import type { NotificationData } from '../../administrador/pages/NotificationData';
...
//Variables
const apiUrl = `http://localhost:8080/Cita/ObtenerCitasPorPaciente/${id}`; // Reemplaza con tu URI

        ...
        <FormKit type="form" @submit="registerAppointment" class="space-y-4" :actions="false">
            ...
            <div class="space-y-4">
                ...
                <div class="flex space-x-4">
                    ...
                    <FormKit type="select" name="especialidad" label="Especialidad" v-model="especialidadSeleccionada"
                ...
                <FormKit type="select" name="medico" label="Médico" v-model="appointmentData.id_medico"
                    input-class="mt-1 block w-full p-2 border border-gray-300 rounded-md text-black"
